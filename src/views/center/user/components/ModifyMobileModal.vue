  ...
  <el-dialog
    ...
    <div class="login">
      <el-form ref="forgetForm" :model="forget" :rules="forgetRules" class="login-form">
        <h1 style="margin-bottom: 34px;font-size: 24px;font-weight: bold;">修改手机号</h1>
        <el-form-item prop="mobile">
          <el-input v-model="forget.mobile" type="text" auto-complete="off" placeholder="请输入旧手机号">
            <svg-icon slot="prefix" icon-class="user" class="el-input__icon input-icon"/>
          </el-input>
        </el-form-item>
        <el-form-item prop="password">
          <el-input v-model="forget.authCode" type="text" auto-complete="off" placeholder="请输入短信验证码">
            <svg-icon slot="prefix" icon-class="password" class="el-input__icon input-icon"/>
            <code-button slot="suffix" url="/auth/senRegisterCode" :mobile="forget.mobile" @success="(uuid) => {forget.uuid = uuid}"></code-button>
          </el-input>
        </el-form-item>
        <el-form-item prop="mobile">
          <el-input v-model="forget.mobile" type="text" auto-complete="off" placeholder="请输入新手机号">
            <svg-icon slot="prefix" icon-class="user" class="el-input__icon input-icon"/>
          </el-input>
        </el-form-item>
        <el-form-item prop="password">
