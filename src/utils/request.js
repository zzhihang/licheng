...
let tipping = false
const whiteList = ['/labor/getWorkerInfo']
...
service.interceptors.request.use(config => {
  ...
  if (!whiteList.some(url => new RegExp(`${url}$`).test(config.url))) {
...
// 通用下载方法
export function download(url, data, filename, contentType) {
  ...
  return service.post(url, data, objData).then(async(res) => {
    console.log(res, 'res')
